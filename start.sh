...
# ==============================================
# ImpactGaming Minecraft Server Startup Script
# Supports: Paper, Purpur, Pufferfish, Fabric, Forge
# Includes Interactive Menu & Auto-Install
# ==============================================

# Show ImpactGaming Banner
show_banner() {
    if [ "$IMPACT_BANNER" == "true" ]; then
        echo -e "\e[38;5;202m"
        echo "  _____                           _____           _             "
        echo " |_   _|                         /  __ \         | |            "
...
main() {
    ...
    # Accept EULA if Forge/Fabric
    if [ "$SERVER_TYPE" == "forge" ] || [ "$SERVER_TYPE" == "fabric" ]; then
